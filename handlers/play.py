                      ...
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nAtau tambahkan secara manual @BotMusicDims ke Grup Anda dan coba lagi</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
    ...
    keyboard = InlineKeyboardMarkup(
            [   
                [
                    ...
                    InlineKeyboardButton("⛑ Group Support", url="https://t.me/Cari_Doi_indonesia")
                
                ],                     
                [
                    InlineKeyboardButton(
                        "Owner Music DIMS", url="https://instagram.com/Dimswhydi_"
                    )
                ],
                [       
                    InlineKeyboardButton(
